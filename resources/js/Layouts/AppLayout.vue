<template>
    <div class="min-h-screen w-full bg-gray-100">
        <div class="flex flex-row w-full">
            <div class="bg-blue-grey-800 w-1/6">
                <!-- Sidebar -->
                <div class="flex flex-col items-center text-white">
                    <div class="w-full mt-16">
                        <inertia-link :href="route('admin.dashboard')"> 
                            <!-- To Modify the route link just add your named route inside :href -->
                            <div v-bind:class="$page.currentRouteName == 'admin.dashboard' ? 'shadow-lg text-left w-full p-3 font-bold bg-blue-grey-900 cursor-pointer': 'text-left w-full p-3 font-bold hover:bg-blue-grey-900 cursor-pointer'">
                    ...
                    <div class="w-full">
                        <inertia-link :href="route('user.index')"> 
                            <!-- To Modify the route link just add your named route inside :href -->
                            <div v-bind:class="$page.currentRouteName == 'user.index' ? 'shadow-lg text-left w-full p-3 font-bold bg-blue-grey-900 cursor-pointer': 'text-left w-full p-3 font-bold hover:bg-blue-grey-900 cursor-pointer'">
                                <svg class="stroke-current text-white mr-12 inline-block h-4 w-4" viewBox="0 0 20 20">
